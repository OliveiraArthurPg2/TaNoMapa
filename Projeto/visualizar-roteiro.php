...
if ($logado && isTurista()) {
    ...
    error_log("=== VERIFICAÇÃO AUTOR ===");
    error_log("Session ID: " . $sessionId);
    error_log("Autor ID: " . $autorId);
    error_log("isAutor: " . ($isAutor ? 'true' : 'false'));
}
            ...
            <?php if ($logado && $usuario): ?>
                <a href="perfil.php" class="perfil-link">
                    <div class="user-avatar">
                        <?php 
                        $temFoto = !empty($usuario['fotoPerfil']);
                        if ($temFoto): 
                            $caminhoFoto = htmlspecialchars($usuario['fotoPerfil']);
                        ?>
        ...
        <div class="content-main">
            <section class="ponto-info" id="secaoSobre">
                <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 1rem;">
                    ...
                    <?php if ($logado && isTurista() && $isAutor): ?>
                        <button class="btn-editar-secao" onclick="editarSobre()">✏️ Editar</button>
                    <?php endif; ?>
                </div>
                <p id="textoSobre"><?php echo nl2br(htmlspecialchars($roteiro->getBio() ?: 'Sem descrição disponível.')); ?></p>
            </section>
            ...
            <section class="galeria-section">
                    ...
                    <div class="galeria-container">
                        <div class="galeria-principal">
                            <img id="fotoPrincipal" 
                                 src="<?php echo htmlspecialchars($pontos[0]['Foto_Capa'] ?? $pontos[0]['Foto_Perfil'] ?? 'img/default_cover.jpg'); ?>" 
                                 alt="<?php echo htmlspecialchars($pontos[0]['Nome']); ?>"
                                 onclick="abrirLightbox('<?php echo htmlspecialchars($pontos[0]['Foto_Capa'] ?? $pontos[0]['Foto_Perfil'] ?? 'img/default_cover.jpg'); ?>')">
                            ...
                            <div class="galeria-contador">
                                <span id="fotoAtual">1</span> / <?php echo count($pontos); ?>
                            </div>
                        ...
                        <div class="galeria-thumbnails" id="galeriaThumbnails">
                            <?php foreach ($pontos as $index => $ponto): ?>
                                <div class="thumbnail-item <?php echo $index === 0 ? 'active' : ''; ?>" 
                                     data-ponto-id="<?php echo $ponto['Id']; ?>"
                                     data-index="<?php echo $index; ?>"
                                     onclick="selecionarPonto(<?php echo $index; ?>)">
                                    <img src="<?php echo htmlspecialchars($ponto['Foto_Capa'] ?? $ponto['Foto_Perfil'] ?? 'img/default_cover.jpg'); ?>" 
                                         alt="<?php echo htmlspecialchars($ponto['Nome']); ?>">
                            ...
                            <?php foreach ($pontos as $index => $ponto): ?>
                                <div class="ponto-detalhado-card" onclick="window.location.href='visualizar-ponto.php?id=<?php echo $ponto['Id']; ?>'">
                                    ...
                                    <div class="ponto-detalhado-foto">
                                        <img src="<?php echo htmlspecialchars($ponto['Foto_Perfil'] ?? $ponto['Foto_Capa'] ?? 'img/default_cover.jpg'); ?>" 
                                             alt="<?php echo htmlspecialchars($ponto['Nome']); ?>"
                ...
                <?php else: ?>
                    <div class="galeria-vazia">
                        <p>Nenhum ponto turístico neste roteiro ainda.</p>
                    </div>
                <?php endif; ?>
            </section>
            ...
            <section class="avaliacoes-section">
                <div class="avaliacoes-header">
                    ...
                    <?php if ($logado && isTurista()): ?>
                        <button class="btn-avaliar" onclick="abrirModalAvaliacao()">✏️ Avaliar Roteiro</button>
                    <?php endif; ?>
                </div>
        ...
        <aside class="content-sidebar">
            <div class="fornecedor-card">
                ...
                <div class="fornecedor-info" onclick="window.location.href='perfil-publico.php?id=<?php echo $autor->getId(); ?>'">
                    <?php if ($autor->getFotoPerfil()): ?>
                        <img src="<?php echo htmlspecialchars($autor->getFotoPerfil()); ?>" 
                             alt="<?php echo htmlspecialchars($autor->getNome()); ?>" 
                             class="fornecedor-avatar">
                    <?php else: ?>
            ...
            <div class="info-card">
                ...
                <div class="info-item">
                    ...
                    <span class="info-value" id="infoPontos"><?php echo count($pontos); ?> locais</span>
                </div>
                <div class="info-item">
            ...
            <div class="modal-body">
                <form id="formAvaliacao">
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="descricao" name="descricao" rows="4" placeholder="Compartilhe sua experiência com este roteiro..."></textarea>
                    </div>
        ...
        <div class="modal-content modal-content-large">
            ...
            <div class="modal-body">
                <form id="formEditarSobre">
                    <div class="form-group">
                        <label for="nomeEdit">Nome do Roteiro *</label>
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="bioEdit" name="bio" rows="4"><?php echo htmlspecialchars($roteiro->getBio()); ?></textarea>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div id="pontosRoteiroEdit" class="pontos-roteiro-edit">
                            <?php if (count($pontos) > 0): ?>
                                <?php foreach ($pontos as $index => $ponto): ?>
                                    <div class="ponto-edit-card" data-ponto-id="<?php echo $ponto['Id']; ?>">
                                        <div class="ponto-edit-foto">
                                            <img src="<?php echo htmlspecialchars($ponto['Foto_Perfil'] ?? 'img/default_cover.jpg'); ?>" 
                                                 alt="<?php echo htmlspecialchars($ponto['Nome']); ?>">
                                        </div>
                                ...
                                <?php endforeach; ?>
                            <?php else: ?>
                                <p class="aviso-vazio">Nenhum ponto adicionado ainda.</p>
                            <?php endif; ?>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="buscarPontoEdit" class="input-busca" 
                               placeholder="🔍 Buscar ponto turístico para adicionar..." 
                               onkeyup="buscarPontosEdit()">
                        <div id="resultadosBuscaEdit" class="resultados-busca-edit" style="display: none;"></div>
                    </div>
